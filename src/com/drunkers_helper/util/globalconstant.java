...
public final class globalconstant {
	...
	public static final Integer[] mThumbIds = {R.drawable.aguila, R.drawable.amigos,
			...
			R.drawable.baltika4, R.drawable.baltika7,R.drawable.bankscaribbean, 
			...
			R.drawable.heady_topper, R.drawable.heineken, R.drawable.karhu, R.drawable.karlovacko,
			...
			R.drawable.palma_louca, R.drawable.peroni_nastro, R.drawable.pint,R.drawable.presidente,
